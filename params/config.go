...
var (
	...
	// TODO : Adding genesis Hash bootstrapped
	TrollupGenesisHash = common.HexToHash("0xfc55fe17119a6152d1435b9ed818fe1415a65b552f5428ee5fc3d81cc63f70aa")
...
var (
	...
	// TrollupChainConfig contains the chain parameters to run a node on the Görli test network.
	TrollupChainConfig = &ChainConfig{
		ChainID:                       big.NewInt(6661),
		HomesteadBlock:                big.NewInt(0),
		DAOForkBlock:                  nil,
		DAOForkSupport:                true,
		EIP150Block:                   big.NewInt(0),
...
var NetworkNames = map[string]string{
	...
	TrollupChainConfig.ChainID.String(): "trollup",
}
